...
class Message(models.Model):
    ...
    stylist = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='stylist_messages')
    ...
    def __str__(self):
        return f"Wiadomość w zleceniu {self.order_id} od {self.get_sender_type_display()}"
